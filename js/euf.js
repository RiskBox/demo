var euf = {
        ...
        cols: [{
            ...
            on:{
                "onItemClick":function(id, e, trg){ 
                    ...
                    webix.message("Click on row: " + obj.risktypelabel +", " + id.row + ", column: " + id.column);
    ...
    showFormPRC: function(productID){
        var prcFormDT=
            {
                view: "datatable", id: "prcFdt", autoheight:true,
                columns:[
        ...
        var prcForm = {
            ...
            width: 600,
            rows:[
                {cols: [{view: "text", name:"risktype", label:"Risk Type", value: "Processing"},
                {view: "text", name:"product", label:"Product", value: productID},
                {view: "text", name: "euf", label: "EUF", value: 0  }                
            ]},
                {view: "forminput", body: prcFormDT},
